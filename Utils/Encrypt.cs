...
namespace Utils
{
    ...
    {
        public const string KEY = "19940808";
        ...
        public static string DEFAULT_ENCRYPT_KEY = GenerateCheckCode();
        ...
        private static string GenerateCheckCode()
        {
            ...
            Random r = new Random(((int)(((ulong)num2) & 0xffffffffL)) | ((int)(num2 >> rep)));
            int n = 8;
            for (int i = 0; i < n; i++)
            {
        ...
        public static string DesDecrypt(string strText)
        {
            try
            {
                return DesDecrypt(strText.Replace(" ", "+"), DEFAULT_ENCRYPT_KEY);
            }
            catch
            {
                return "";
